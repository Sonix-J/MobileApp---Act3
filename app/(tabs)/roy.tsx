  ...
  return (
    ...
    >
      ...
      <View style={styles.adsContainer1}>
        <Text style={{ color: 'white', fontSize: 24, fontWeight: 'bold' }}>Roy wants to link up with you.</Text>
        <Text style={{ color: 'white', fontSize: 16 }}>Roy is 5 minutes away from your location.</Text>
      </View>
