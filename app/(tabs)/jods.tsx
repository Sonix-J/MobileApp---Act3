  ...
  return (
    ...
    >
      ...
      <View style={styles.adsContainer1}>
        <Text style={{ color: 'white', fontSize: 24, fontWeight: 'bold' }}>Jodeci wants to link up with you.</Text>
        <Text style={{ color: 'white', fontSize: 16 }}>Jodeci is 5 minutes away from your location.</Text>
      </View>
      <View style={styles.galleryContainer}>
        ...
        <View style={styles.galleryRow}>
          ...
          <View style={styles.gallery}>
            ...
            />
            {/* <Image
              source={require("../../assets/images/jodsImg/jodsUpload4.jpg")}
              style={styles.uploadedPics}
            />
            <Image
              source={require("../../assets/images/jodsImg/jodsUpload5.jpg")}
              style={styles.uploadedPics}
            /> */}
          </View>
