  ...
  return (
    ...
    >
      ...
      <View style={styles.personInfo}>
        <View>
          <Text style={{ color: "white", fontSize: 16 }}>Birthday: 87</Text>
          <Text style={{ color: "white", fontSize: 16 }}>
            Contact No#: Canada, Chicago, France
          </Text>
          <Text style={{ color: "white", fontSize: 16 }}>Email: 9'0</Text>
        </View>
        <View>
      ...
      <View style={styles.galleryContainer}>
        ...
        <View style={styles.galleryRow}>
          <View style={styles.gallery}>
            ...
            />
            {/* <Image
              source={require("../../assets/images/enzoImg/danUpload4.jpg")}
              style={styles.uploadedPics}
            /> */}
          </View>
        </View>
